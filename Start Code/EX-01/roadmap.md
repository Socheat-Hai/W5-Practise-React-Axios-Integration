...
- [x] Verify Express.js API is running at `http://localhost:5000`
- [x] Confirm `main.jsx` wraps `<App />` inside `<BrowserRouter>`
- [x] Confirm `App.jsx` defines routes for `/`, `/add`, `/update/:id`, `/articles/:id`
- [x] Create `context/` folder with `mission.md`, `requirement.md`, `roadmap.md`
...
- [x] Import `useEffect`, `useState` from React in `ArticleList.jsx`
